...
The ESPNow component allows ESPHome to communicate with esp32 or esp8266 devices in a simple and unrestricted way.
It enables the option to interact with other esp32 or esp8266 devices over the Espressif's ESP-NOW protocol, see
